...
-- Service role has full access (bridge uses service key)
-- No restrictive policies needed for insert/update/delete since
-- the bridge connects with the service_role key.
